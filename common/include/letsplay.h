...
#define LP_NO_LAVA_DAMAGE 0             // disable lava damage
...
#define LP_ALWAYS_DROP 0                // always drop powerup
#define LP_MULTIPLE_DROP 0              // increase powerup drops
#define LP_CRAZY_SPAWN 0                // Destroyed robots create more/different enemies
#define LP_ROBOT_GENERATOR_OVERRIDE 0	// Define type of robot to spawn
#define LP_SLOWMOTION 0					// Slow down enemies
#define LP_CLOAKED_ALL 0				// All robots are cloaked
#define LP_RAMBO_BOT 0					// Buddy fires megamissiles etc
